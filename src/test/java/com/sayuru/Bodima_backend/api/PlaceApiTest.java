...
@ActiveProfiles("test") // Optional: use a test profile
public class PlaceApiTest {
    ...
    public void setup() {
        ...
        // Preloaded test user (ensure this exists in your test DB)
        Users user = new Users();
        user.setUsername("sayuru@gmail.com");
        user.setPassword("1234");
    ...
    public void testAddPlace_fail_missingName() {
        ...
        given()
                ...
                .post("/api/places")
                .then()
                .statusCode(HttpStatus.INTERNAL_SERVER_ERROR.value()); // Validation failure
    }
}
